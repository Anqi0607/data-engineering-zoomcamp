...
select trips_unioned.tripid, 
    ...
    CONCAT(CAST(EXTRACT(YEAR FROM trips_unioned.pickup_datetime) AS STRING), '_Q', CAST(EXTRACT(QUARTER FROM trips_unioned.pickup_datetime) AS STRING)) AS year_quarter,
